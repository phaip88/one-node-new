...
// Fixed configuration with selective environment variable support
const UUID = '8b9c2d4e-f1a3-4567-8901-234567890abc';  // Fixed UUID, no environment override
const DOMAIN = process.env.DOMAIN || 'example.com';    // Allow environment override
